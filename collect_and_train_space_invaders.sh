...
python run_cswm_space_invaders.py with "dataset_path=data/spinv_train" "model_config.copy_action=True" "eval_dataset_path=data/spinv_eval" "seed=44" "epochs=100" "eval_steps=1,5,10" "learning_rate=5e-4" "model_save_path=data/cswm_spinv.pt" "run_name=CSWM Space Invaders"